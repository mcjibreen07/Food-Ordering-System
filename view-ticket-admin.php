        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li><h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1">Arraudha Restaurand System</a></h1></li>
                    </ul>
...
<div class="section">
 ...
 <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span>Copyright © <?php echo date("Y"); ?><span class="right"><a class="grey-text text-lighten-4" href="https://github.com/mcjibreen07">Miapoly Student</a></span>
        </div>
    </div>
  </footer>
    <!-- END FOOTER -->
